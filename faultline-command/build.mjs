...
// Typography is embedded rather than linked, so the game keeps its identity with
// no network access at all. Regenerate with: node tools/embed-fonts.mjs
const fonts = '<style>' + readFileSync('src/ui/fonts.css', 'utf8') + '</style>';
